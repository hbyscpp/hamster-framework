...
public class EndpointConfig {
	...
	// TODO 控制读写
	private ConcurrentHashMap<String, ConfigItem> configs = new ConcurrentHashMap<String, ConfigItem>();
	...
	public String toString() {
		...
		for (ConfigItem ci : configs.values()) {
			if (ci.isReadOnly()) {
				rstr.append(ci.getKey()).append(Constants.EQUAL)
						.append(ci.getValue()).append(Constants.AND);
			} else {
				rwstr.append(ci.getKey()).append(Constants.EQUAL)
						.append(ci.getValue()).append(Constants.AND);
