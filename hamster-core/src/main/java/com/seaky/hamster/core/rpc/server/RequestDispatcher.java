...
public class RequestDispatcher<Req, Rsp> {
  ...
  public static class MessageTask<Req, Rsp> implements Runnable {
    ...
    public void run() {
      ...
      String serviceName = context.getAttribute(ServiceContext.SERVICENAME, String.class);
      String app = context.getAttribute(ServiceContext.APP, String.class);
      String serviceVersion = context.getAttribute(ServiceContext.VERSION, String.class);
      String group = context.getAttribute(ServiceContext.GROUP, String.class);
      ...
      EndpointConfig sc =
          context.getAttribute(ServiceContext.PROVIDER_CONFIG, EndpointConfig.class);

      if (!Utils.isMatch(service.paramTypes(),
