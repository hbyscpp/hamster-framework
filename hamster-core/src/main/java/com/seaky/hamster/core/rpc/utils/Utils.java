...
public class Utils {
	...
	public static List<ServiceInterceptor> extractByProcessPhase(
		...
		sis.add(ServiceInterceptorManager.createServiceInterceptor("log"));
	...
	public static String createServerAndClientAddress(String clientHost,int clientPort,String serverHost,int serverPort)
	{
		StringBuilder sb = new StringBuilder();
